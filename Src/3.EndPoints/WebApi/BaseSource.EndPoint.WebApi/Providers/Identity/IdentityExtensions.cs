using BaseSource.EndPoint.WebApi.Providers.Identity.Handlers;
using BaseSource.EndPoint.WebApi.Providers.Identity.Options;
...
public static class IdentityExtensions
{
    ...
    private static IServiceCollection AddIdentityServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        .AddEntityFrameworkStores<CommandDatabaseContext>()
